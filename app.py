            ...
            if len(filtered_df) > 0:
                ...
                with tab_excel:
                    ...
                    if selected_export_cols:
                        ...
                        # 🔥 เพิ่มคอลัมน์ "ลำดับ" เข้าไปเป็นคอลัมน์แรกก่อนส่งออก Excel
                        final_excel_df = edited_excel_df.copy()
                        final_excel_df.insert(0, 'ลำดับ', range(1, len(final_excel_df) + 1))
                        final_export_cols = ['ลำดับ'] + selected_export_cols
                        
                        excel_bytes = generate_excel_with_images(final_excel_df, final_export_cols)
